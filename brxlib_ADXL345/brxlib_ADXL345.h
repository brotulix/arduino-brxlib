...
/*=========================================================================
    REGISTERS
    -----------------------------------------------------------------------*/
    #define ADXL345_MG2G_MULTIPLIER 4  // 4mg per lsb
/*=========================================================================*/
...
class brxlib_ADXL345 : public brxlib_sensors {
 public:
  brxlib_ADXL345(int32_t sensorID = -1);
  brxlib_ADXL345(uint8_t clock, uint8_t miso, uint8_t mosi, uint8_t cs, int32_t sensorID = -1);
